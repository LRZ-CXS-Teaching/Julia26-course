...
2. Julia benchmarked against other languages
    * [Julia microbenchmarking project](https://julialang.github.io/Microbenchmarks/dev/benchmarks/)
    * [The Bechmarkgame](https://benchmarksgame-team.pages.debian.net/benchmarksgame/) (more general)
3. [Julia parametric types delve-in](https://ziotom78.github.io/julia/2024/09/30/julia-parametric-types.html)
4. [What is the two-language problem?](https://discourse.julialang.org/t/two-language-problem-what-is-it/82925/3)
5. [JIT compilation and method invalidations](https://julialang.org/blog/2020/08/invalidations/)
...
* [Julia installation and `juliaup`](https://julialang.org/downloads/platform)
* [REPL intro](https://docs.julialang.org/en/v1/stdlib/REPL)
* [Pkg intro](https://docs.julialang.org/en/v1/stdlib/Pkg)
